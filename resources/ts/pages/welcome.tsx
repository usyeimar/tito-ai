...
import { workspaces, login, register } from '@/routes';
                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Tito has an incredibly rich ecosystem.
                                <br />
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            ...
                            <div className="flex h-full w-full items-center justify-center p-12">
                                <img src="/media/logo.png" alt="Tito Logo" className="w-full max-w-[200px] object-contain opacity-100 transition-all duration-750 starting:opacity-0 motion-safe:starting:translate-y-6" />
                            </div>
