...
* @route 'https://app.tito.ai/forgot-password'
*/
...
request.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/forgot-password',
...
* @route 'https://app.tito.ai/reset-password/{token}'
*/
...
reset.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/reset-password/{token}',
} satisfies RouteDefinition<["get","head"]>
...
* @route 'https://app.tito.ai/reset-password'
*/
...
update.definition = {
    methods: ["post"],
    url: 'https://app.tito.ai/reset-password',
} satisfies RouteDefinition<["post"]>
...
* @route 'https://app.tito.ai/user/confirm-password'
*/
...
confirm.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/user/confirm-password',
} satisfies RouteDefinition<["get","head"]>
...
* @route 'https://app.tito.ai/user/confirmed-password-status'
*/
...
confirmation.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/user/confirmed-password-status',
} satisfies RouteDefinition<["get","head"]>
