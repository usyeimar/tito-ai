...
* @route 'https://app.tito.ai/two-factor-challenge'
*/
...
login.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/two-factor-challenge',
...
* @route 'https://app.tito.ai/user/two-factor-authentication'
*/
...
enable.definition = {
    methods: ["post"],
    url: 'https://app.tito.ai/user/two-factor-authentication',
...
* @route 'https://app.tito.ai/user/confirmed-two-factor-authentication'
*/
...
confirm.definition = {
    methods: ["post"],
    url: 'https://app.tito.ai/user/confirmed-two-factor-authentication',
} satisfies RouteDefinition<["post"]>
...
* @route 'https://app.tito.ai/user/two-factor-qr-code'
*/
...
qrCode.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/user/two-factor-qr-code',
} satisfies RouteDefinition<["get","head"]>
...
* @route 'https://app.tito.ai/user/two-factor-secret-key'
*/
...
secretKey.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/user/two-factor-secret-key',
} satisfies RouteDefinition<["get","head"]>
...
* @route 'https://app.tito.ai/user/two-factor-recovery-codes'
*/
...
recoveryCodes.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/user/two-factor-recovery-codes',
} satisfies RouteDefinition<["get","head"]>
