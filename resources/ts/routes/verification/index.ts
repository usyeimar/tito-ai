...
* @route 'https://app.tito.ai/email/verify'
*/
...
notice.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/email/verify',
...
* @route 'https://app.tito.ai/email/verify/{id}/{hash}'
*/
...
verify.definition = {
    methods: ["get","head"],
    url: 'https://app.tito.ai/email/verify/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
...
* @route 'https://app.tito.ai/email/verification-notification'
*/
...
send.definition = {
    methods: ["post"],
    url: 'https://app.tito.ai/email/verification-notification',
